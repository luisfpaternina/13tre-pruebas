...
class TestAccountExogenusSettings(TransactionCase):
    ...
    def test_check_deducible_percentage(self):
        with self.assertRaises(ValidationError):
            self.AccountConceptExogenusLine_1.write({
                'deducible_percentage': 101
            })
            self.AccountConceptExogenusLine_1._check_deducible_percentage()
