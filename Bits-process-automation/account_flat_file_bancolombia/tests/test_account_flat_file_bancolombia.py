...
class TestAccountFlatFileDavivienda(TransactionCase):
    ...
    def test_without_active_model_get_collect_data_bank(self):
    ...
    def test_create_default_string_char(self):
        self.account_payment.post()
        self.res_bank.write({
                'bic': '1'
        })
        ...
        res = record.create_default_string_char('2', 'A', '', '0', 'R')
    ...
    def test_get_transaction_type(self):
        ...
        res = record.get_transaction_type('2', 'A', '', 'R')

    def test_most_quantity_character(self):
        self.account_payment.post()
        self.partner_company.write({
                'number_identification': '1111111111111111111111111111'
        })
        record = self.FlatFile.new({
            'partner_id': self.account_payment.partner_id.id,
            'payment_description': "DEMO001",
