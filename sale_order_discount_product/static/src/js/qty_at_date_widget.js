odoo.define('sale_order_discount_product.QtyAtDateWidget', function (require) {
    "use strict";
    ...
    var QtyAtDateWidget = Widget.extend({
        template: 'sale_order_discount_product.qtyAtDate',
        ...
        _getContent() {
            ...
            const $content = $(QWeb.render('sale_order_discount_product.QtyDetailPopOver', {
                data: this.data,
            }));
